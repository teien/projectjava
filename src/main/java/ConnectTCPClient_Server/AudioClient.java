...
public class AudioClient {
    private static class AudioHandler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            AudioHandler audioHandler = new AudioHandler(socket);
            audioHandler.start();

            // Simulate button press to start and stop sending audio
            Thread.sleep(5000);  // Wait for 5 seconds
            System.out.println("Starting to send audio");
            audioHandler.startSending();

            Thread.sleep(10000);  // Send audio for 10 seconds
            System.out.println("Stopping sending audio");
