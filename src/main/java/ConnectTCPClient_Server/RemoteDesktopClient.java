...
public class RemoteDesktopClient extends JFrame {
    ...
    private void sendFile() {
        if (!checkConnection()) {
            JOptionPane.showMessageDialog(this, "Chưa kết nối tới server", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                dos.flush();
                fis.close();
                JOptionPane.showMessageDialog(this, "File đã được gửi thành công", "Thành công", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException e) {
                e.printStackTrace();
